...
_view_users_dependency = Depends(view_users_only)
...
@cache.private
def me(login=_logged_in_dependency) -> models.UserResult:
...
@cache.private
def roles(_admin=_view_users_dependency) -> list[str]:
    """
...
@cache.private
def user(user_id: int, _moderator=_moderator_dependency) -> models.UserResult:
    """
...
@cache.private
def role_users(
    role_name: models.RoleName, _admin=_view_users_dependency
