...
def test_storefront_info_basic(client, snapshot):
    ...
    response = client.get("/purchases/storefront-info", params={"app_id": "org.sugarlabs.Maze"})
...
def test_is_free_software_endpoint_returns_bool(client, snapshot):
    ...
    response = client.get(
        "/purchases/storefront-info/is-free-software", params={"app_id": "org.sugarlabs.Maze"}
    )
