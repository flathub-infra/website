...
def upgrade():
    ...
    op.execute("DELETE FROM qualitymoderation WHERE guideline_id = 'screenshots-not-maximized'")
    op.execute("DELETE FROM qualitymoderation WHERE guideline_id = 'screenshots-include-window-shadow'")
    op.execute("DELETE FROM qualitymoderation WHERE guideline_id = 'screenshots-multiple-screenshots'")
