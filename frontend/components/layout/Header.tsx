    ...
    return (
        <header>
            <nav>
                <div id="brand">
                    <Link href="/">
                        <img src="https://flathub.org/assets/themes/flathub/flathub-logo-toolbar.svg" alt="Flathub" />
                    </Link>
                </div>

                <div id="search">
                    <form onSubmit={onSubmit}>
                        <input type="search" name="q" placeholder="Search apps" onChange={onChange} value={query} />
                    </form>
                </div>
