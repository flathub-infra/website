...
const PrivacyPolicyClient = (): JSX.Element => {
  ...
  return (
    <div className="prose mt-12 flex max-w-full flex-col px-[5%] text-justify dark:prose-invert md:px-[20%] 2xl:px-[30%]">
      ...
      <p>
        ...
        of information that is collected and recorded by Flathub and how we use
        it.
      </p>
      ...
      <p>
        Flathub follows a standard procedure of using log files. These files log
        ...
        information that is personally identifiable. The purpose information is
      ...
      <p>
        Like any other website, Flathub uses &apos;cookies&apos;. These cookies
      ...
      <p>
        Request that a business that sells a consumer&apos;s personal data, sell
      ...
      <p>
        Flathub does not knowingly collect any Personal Identifiable Information
