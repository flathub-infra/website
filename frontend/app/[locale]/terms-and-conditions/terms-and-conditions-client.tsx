...
const TermsAndConditionsClient = (): JSX.Element => {
  ...
  return (
    <div className="prose mt-12 flex max-w-full flex-col px-[5%] text-justify dark:prose-invert md:px-[20%] 2xl:px-[30%]">
      ...
      <p>
        ...
        &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer to Flathub.
        Flathub offers this website, including all information, tools and
      ...
      <p>
        ...
        third-pearty&apos;s policies and practices and make sure you understand
      ...
      <p>
        ...
        shall Flathub, our directors, officers, employees, affiliates, agents,
      ...
      <p>
        You agree to indemnify, defend and hold harmless Flathub and our parent,
