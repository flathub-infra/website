...
import { MeilisearchResponseAppsIndex, MainCategory } from "../../../../../../../../src/codegen";
...
export default function SubcategoryPageClient({ applications, mainCategory, subcategory, page }: Props) {
  const t = useTranslations();
  
  const category = mainCategory as MainCategory;
  let categoryName = tryParseCategory(category, t);
  let subcategoryName = tryParseSubCategory(subcategory, t) ?? t(subcategory.toLowerCase());
