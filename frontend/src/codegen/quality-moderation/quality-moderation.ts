...
export const getQualityModerationStatusQualityModerationStatusGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/quality-moderation/status`,
    {
      ...options,
...
export const getPassingQualityAppsQualityModerationPassingAppsGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/quality-moderation/passing-apps`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getAppPickRecommendationsQualityModerationAppPickRecommendationsGet =
  (
    ...
    return axios.get(
      `${getApiBaseUrl()}/quality-moderation/app-pick-recommendations`,
      {
        ...options,
        params: { ...params, ...options?.params },
        paramsSerializer: (params) =>
...
export const getQualityModerationStatsQualityModerationFailedByGuidelineGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/quality-moderation/failed-by-guideline`,
    options,
  )
}
...
export const getQualityModerationForAppQualityModerationAppIdGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/quality-moderation/${appId}`,
    options,
  )
}
...
export const getQualityModerationStatusForAppQualityModerationAppIdStatusGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/quality-moderation/${appId}/status`,
    options,
  )
}
...
export const requestReviewForAppQualityModerationAppIdRequestReviewPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/quality-moderation/${appId}/request-review`,
    undefined,
    options,
  )
}
...
export const setFullscreenAppQualityModerationAppIdFullscreenPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/quality-moderation/${appId}/fullscreen`,
    undefined,
    {
      ...options,
      params: { ...params, ...options?.params },
