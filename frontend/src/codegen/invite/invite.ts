...
export const getInviteStatusInvitesAppIdGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/invites/${appId}`,
    options,
  )
}

export const getGetInviteStatusInvitesAppIdGetQueryKey = (appId?: string) => {
  return [`${getApiBaseUrl()}/invites/${appId}`] as const
}
...
export const inviteDeveloperInvitesAppIdInvitePost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/invites/${appId}/invite`,
    undefined,
    {
      ...options,
...
export const acceptInviteInvitesAppIdAcceptPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/invites/${appId}/accept`,
    undefined,
    options,
  )
}
...
export const declineInviteInvitesAppIdDeclinePost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/invites/${appId}/decline`,
    undefined,
    options,
  )
}
...
export const leaveTeamInvitesAppIdLeavePost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/invites/${appId}/leave`,
    undefined,
    options,
  )
}
...
export const getAppDevelopersInvitesAppIdDevelopersGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/invites/${appId}/developers`,
    options,
  )
}
...
export const removeDeveloperInvitesAppIdRemoveDeveloperPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/invites/${appId}/remove-developer`,
    undefined,
    {
      ...options,
      params: { ...params, ...options?.params },
...
export const revokeInviteInvitesAppIdRevokePost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/invites/${appId}/revoke`,
    undefined,
    {
      ...options,
      params: { ...params, ...options?.params },
