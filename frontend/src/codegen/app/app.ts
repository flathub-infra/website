...
export const getEolRebaseEolRebaseGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/eol/rebase`,
    options,
  )
}

export const getGetEolRebaseEolRebaseGetQueryKey = () => {
  return [`${getApiBaseUrl()}/eol/rebase`] as const
}
...
export const getEolRebaseAppidEolRebaseAppIdGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/eol/rebase/${appId}`,
    {
      ...options,
...
export const getEolMessageEolMessageGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/eol/message`,
    options,
  )
}

export const getGetEolMessageEolMessageGetQueryKey = () => {
  return [`${getApiBaseUrl()}/eol/message`] as const
}
...
export const getEolMessageAppidEolMessageAppIdGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/eol/message/${appId}`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const listAppstreamAppstreamGet = (
  ...
  return axios.get(`${getApiBaseUrl()}/appstream`, {
    ...options,
    params: { ...params, ...options?.params },
    paramsSerializer: (params) =>
      qs.stringify(params, { arrayFormat: "repeat" }),
...
export const getIsFullscreenAppIsFullscreenAppAppIdGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/is-fullscreen-app/${appId}`,
    options,
  )
}
...
export const getRuntimeListRuntimesGet = (
  ...
  return axios.get(`${getApiBaseUrl()}/runtimes`, options)
}

export const getGetRuntimeListRuntimesGetQueryKey = () => {
  return [`${getApiBaseUrl()}/runtimes`] as const
}
...
export const getSummarySummaryAppIdGet = (
  ...
  return axios.get(`${getApiBaseUrl()}/summary/${appId}`, {
    ...options,
    params: { ...params, ...options?.params },
    paramsSerializer: (params) =>
      qs.stringify(params, { arrayFormat: "repeat" }),
...
export const getPlatformsPlatformsGet = (
  ...
  return axios.get(`${getApiBaseUrl()}/platforms`, options)
}

export const getGetPlatformsPlatformsGetQueryKey = () => {
  return [`${getApiBaseUrl()}/platforms`] as const
}
...
export const getAddonsAddonAppIdGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/addon/${appId}`,
    options,
  )
}

export const getGetAddonsAddonAppIdGetQueryKey = (appId?: string) => {
  return [`${getApiBaseUrl()}/addon/${appId}`] as const
}
...
export const getExceptionsExceptionsGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/exceptions/`,
    options,
  )
}

export const getGetExceptionsExceptionsGetQueryKey = () => {
  return [`${getApiBaseUrl()}/exceptions/`] as const
}
...
export const getExceptionsForAppExceptionsAppIdGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/exceptions/${appId}`,
    options,
  )
}
...
export const addToFavoritesFavoritesAppIdAddPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/favorites/${appId}/add`,
    undefined,
    options,
  )
}
...
export const removeFromFavoritesFavoritesAppIdRemoveDelete = (
  ...
  return axios.delete(
    `${getApiBaseUrl()}/favorites/${appId}/remove`,
    options,
  )
}
...
export const getFavoritesFavoritesGet = (
  ...
  return axios.get(`${getApiBaseUrl()}/favorites`, options)
}

export const getGetFavoritesFavoritesGetQueryKey = () => {
  return [`${getApiBaseUrl()}/favorites`] as const
}
...
export const isFavoritedFavoritesAppIdGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/favorites/${appId}`,
    options,
  )
}

export const getIsFavoritedFavoritesAppIdGetQueryKey = (appId?: string) => {
  return [`${getApiBaseUrl()}/favorites/${appId}`] as const
}
