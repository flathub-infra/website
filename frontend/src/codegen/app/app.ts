...
export const getCategoryCategoryCategoryGet = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<GetCategoryCategoryCategoryGet200>> => {
...
export const getSubcategoryCategoryCategorySubcategoriesSubcategoryGet = (
  ...
  AxiosResponse<GetSubcategoryCategoryCategorySubcategoriesSubcategoryGet200>
> => {
...
export const getDeveloperDeveloperDeveloperGet = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<GetDeveloperDeveloperDeveloperGet200>> => {
...
export const postSearchSearchPost = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<PostSearchSearchPost200>> => {
...
export const getRecentlyUpdatedCollectionRecentlyUpdatedGet = (
  ...
  AxiosResponse<GetRecentlyUpdatedCollectionRecentlyUpdatedGet200>
> => {
...
export const getRecentlyAddedCollectionRecentlyAddedGet = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<GetRecentlyAddedCollectionRecentlyAddedGet200>> => {
...
export const getVerifiedCollectionVerifiedGet = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<GetVerifiedCollectionVerifiedGet200>> => {
...
export const getPopularLastMonthPopularLastMonthGet = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<GetPopularLastMonthPopularLastMonthGet200>> => {
...
export const getSummarySummaryAppIdGet = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<GetSummarySummaryAppIdGet200>> => {
...
export const getExceptionsExceptionsGet = (
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<GetExceptionsExceptionsGet200>> => {
...
export const getExceptionsForAppExceptionsAppIdGet = (
  appId: string,
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<GetExceptionsForAppExceptionsAppIdGet200>> => {
