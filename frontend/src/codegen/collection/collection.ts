...
export const getCategoriesCollectionCategoryGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/category`,
    options,
  )
}
...
export const getCategoryCollectionCategoryCategoryGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/category/${category}`,
    {
      ...options,
...
export const getSubcategoryCollectionCategoryCategorySubcategoriesGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/category/${category}/subcategories`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getKeywordCollectionKeywordGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/keyword`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getDevelopersCollectionDeveloperGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/developer`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getDeveloperCollectionDeveloperDeveloperGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/developer/${developer}`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getRecentlyUpdatedCollectionRecentlyUpdatedGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/recently-updated`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getRecentlyAddedCollectionRecentlyAddedGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/recently-added`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getVerifiedCollectionVerifiedGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/verified`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getMobileCollectionMobileGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/mobile`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getPopularLastMonthCollectionPopularGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/popular`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getTrendingLastTwoWeeksCollectionTrendingGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/trending`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const getMostFavoritedCollectionFavoritesGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/collection/favorites`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
