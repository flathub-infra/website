...
export const usersUsersGet = (
  ...
  return axios.get(`${getApiBaseUrl()}/users`, {
    ...options,
...
export const rolesUsersRolesGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/users/roles`,
    options,
  )
}

export const getRolesUsersRolesGetQueryKey = () => {
  return [`${getApiBaseUrl()}/users/roles`] as const
}
...
export const getUserUsersUserIdGetQueryKey = (userId?: number) => {
  return [`${getApiBaseUrl()}/users/${userId}`] as const
}
...
export const roleUsersUsersRolesRoleNameGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/users/roles/${roleName}`,
    options,
  )
}
