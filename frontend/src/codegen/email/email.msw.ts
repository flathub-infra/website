...
import type { BuildNotificationEmailsBuildNotificationPost200 } from ".././model"

export const getBuildNotificationEmailsBuildNotificationPostResponseMock =
  (): BuildNotificationEmailsBuildNotificationPost200 => ({})
...
export const getBuildNotificationEmailsBuildNotificationPostMockHandler = (
  overrideResponse?: BuildNotificationEmailsBuildNotificationPost200,
) => {
  return http.post("*/emails/build-notification", async () => {
    ...
    return new HttpResponse(
      JSON.stringify(
        overrideResponse
          ? overrideResponse
          : getBuildNotificationEmailsBuildNotificationPostResponseMock(),
      ),
      {
        status: 200,
        headers: {
