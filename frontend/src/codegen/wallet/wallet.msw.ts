...
export const getSetTransactionCardWalletTransactionsTxnSetcardPostResponseMock =
  (): SetTransactionCardWalletTransactionsTxnSetcardPost200 => ({})
...
export const getWebhookWalletWebhookStripePostResponseMock =
  (): WebhookWalletWebhookStripePost200 => ({})
...
export const getPostRemovecardWalletRemovecardPostMockHandler = (
  overrideResponse?: PostRemovecardWalletRemovecardPost200,
) => {
...
export const getSetTransactionCardWalletTransactionsTxnSetcardPostMockHandler =
  (
    overrideResponse?: SetTransactionCardWalletTransactionsTxnSetcardPost200,
  ) => {
    return http.post("*/wallet/transactions/:txn/setcard", async () => {
      ...
      return new HttpResponse(
        JSON.stringify(
          overrideResponse
            ? overrideResponse
            : getSetTransactionCardWalletTransactionsTxnSetcardPostResponseMock(),
        ),
        {
          status: 200,
          headers: {
...
export const getCancelTransactionWalletTransactionsTxnCancelPostMockHandler = (
  overrideResponse?: CancelTransactionWalletTransactionsTxnCancelPost200,
) => {
...
export const getGetStripedataWalletStripedataGetMockHandler = (
  overrideResponse?: GetStripedataWalletStripedataGet200,
) => {
...
export const getGetTxnStripedataWalletTransactionsTxnStripeGetMockHandler = (
  overrideResponse?: GetTxnStripedataWalletTransactionsTxnStripeGet200,
) => {
...
export const getSetSavecardWalletTransactionsTxnSavecardPostMockHandler = (
  overrideResponse?: SetSavecardWalletTransactionsTxnSavecardPost200,
) => {
...
export const getSetPendingWalletTransactionsTxnSetpendingPostMockHandler = (
  overrideResponse?: SetPendingWalletTransactionsTxnSetpendingPost200,
) => {
...
export const getWebhookWalletWebhookStripePostMockHandler = (
  overrideResponse?: WebhookWalletWebhookStripePost200,
) => {
  return http.post("*/wallet/webhook/stripe", async () => {
    ...
    return new HttpResponse(
      JSON.stringify(
        overrideResponse
          ? overrideResponse
          : getWebhookWalletWebhookStripePostResponseMock(),
      ),
      {
        status: 200,
        headers: {
