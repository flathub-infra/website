...
export const getWalletinfoWalletWalletinfoGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/wallet/walletinfo`,
    options,
  )
}

export const getGetWalletinfoWalletWalletinfoGetQueryKey = () => {
  return [`${getApiBaseUrl()}/wallet/walletinfo`] as const
}
...
export const postRemovecardWalletRemovecardPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/wallet/removecard`,
    paymentCardInfo,
    options,
  )
}
...
export const getTransactionsWalletTransactionsGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/wallet/transactions`,
    {
      ...options,
...
export const getTransactionByIdWalletTransactionsTxnGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/wallet/transactions/${txn}`,
    options,
  )
}
...
export const setTransactionCardWalletTransactionsTxnSetcardPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/wallet/transactions/${txn}/setcard`,
    paymentCardInfo,
    options,
  )
}
...
export const cancelTransactionWalletTransactionsTxnCancelPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/wallet/transactions/${txn}/cancel`,
    undefined,
    options,
  )
}
...
export const getStripedataWalletStripedataGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/wallet/stripedata`,
    options,
  )
}

export const getGetStripedataWalletStripedataGetQueryKey = () => {
  return [`${getApiBaseUrl()}/wallet/stripedata`] as const
}
...
export const getTxnStripedataWalletTransactionsTxnStripeGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/wallet/transactions/${txn}/stripe`,
    options,
  )
}
...
export const setSavecardWalletTransactionsTxnSavecardPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/wallet/transactions/${txn}/savecard`,
    transactionSaveCard,
    options,
  )
}
...
export const setPendingWalletTransactionsTxnSetpendingPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/wallet/transactions/${txn}/setpending`,
    undefined,
    options,
  )
}
...
export const webhookWalletWebhookStripePost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/wallet/webhook/stripe`,
    undefined,
    options,
  )
}
