...
export const getModerationAppsModerationAppsGet = (
  ...
  return axios.get(`${getApiBaseUrl()}/moderation/apps`, {
    ...options,
...
export const getModerationAppModerationAppsAppIdGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/moderation/apps/${appId}`,
    {
      ...options,
      params: { ...params, ...options?.params },
      paramsSerializer: (params) =>
...
export const submitReviewRequestModerationSubmitReviewRequestPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/moderation/submit_review_request`,
    reviewRequest,
    options,
  )
}
...
export const submitReviewModerationRequestsIdReviewPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/moderation/requests/${id}/review`,
    review,
    options,
  )
}
