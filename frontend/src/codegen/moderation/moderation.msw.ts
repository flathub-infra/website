...
export const getGetModerationAppsModerationAppsGetResponseMock = (overrideResponse: Partial< ModerationAppsResponse > = {}): ModerationAppsResponse => ({apps: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({appid: faker.string.alpha(20), is_new_submission: faker.datatype.boolean(), request_types: faker.helpers.arrayElements(Object.values(ModerationRequestType)), updated_at: faker.helpers.arrayElement([faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`,null]), undefined])})), apps_count: faker.number.int({min: undefined, max: undefined}), ...overrideResponse})

export const getGetModerationAppModerationAppsAppIdGetResponseMock = (overrideResponse: Partial< ModerationApp > = {}): ModerationApp => ({requests: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({app_id: faker.string.alpha(20), build_id: faker.number.int({min: undefined, max: undefined}), comment: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha(20),null]), undefined]), created_at: `${faker.date.past().toISOString().split('.')[0]}Z`, handled_at: faker.helpers.arrayElement([faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`,null]), undefined]), handled_by: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha(20),null]), undefined]), id: faker.number.int({min: undefined, max: undefined}), is_approved: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.datatype.boolean(),null]), undefined]), is_new_submission: faker.datatype.boolean(), is_outdated: faker.datatype.boolean(), job_id: faker.number.int({min: undefined, max: undefined}), request_data: faker.helpers.arrayElement([faker.helpers.arrayElement([{current_values: {
        [faker.string.alphanumeric(5)]: faker.helpers.arrayElement([faker.string.alpha(20),Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({}))faker.datatype.boolean(),null])
      }, keys: {
        [faker.string.alphanumeric(5)]: faker.helpers.arrayElement([faker.string.alpha(20),Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({}))faker.datatype.boolean(),null])
...
export const getSubmitReviewModerationRequestsIdReviewPostResponseMock = (): SubmitReviewModerationRequestsIdReviewPost200 => (faker.helpers.arrayElement([{github_issue_url: faker.string.alpha(20)},null]))
