...
> => {
  return axios.get(
    `${getApiBaseUrl()}/verification/${appId}/status`,
    options,
  )
}
...
export const getAvailableMethodsVerificationAppIdAvailableMethodsGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/verification/${appId}/available-methods`,
    {
      ...options,
...
> => {
  return axios.post(
    `${getApiBaseUrl()}/verification/${appId}/verify-by-login-provider`,
    undefined,
    {
      ...options,
      params: { ...params, ...options?.params },
...
export const requestOrganizationAccessGithubVerificationRequestOrganizationAccessGithubGet =
  (options?: AxiosRequestConfig): Promise<AxiosResponse<LinkResponse>> => {
    return axios.get(
      `${getApiBaseUrl()}/verification/request-organization-access/github`,
      options,
    )
  }
...
export const setupWebsiteVerificationVerificationAppIdSetupWebsiteVerificationPost =
  (
    ...
    return axios.post(
      `${getApiBaseUrl()}/verification/${appId}/setup-website-verification`,
      undefined,
      {
        ...options,
        params: { ...params, ...options?.params },
...
export const confirmWebsiteVerificationVerificationAppIdConfirmWebsiteVerificationPost =
  (
    ...
    return axios.post(
      `${getApiBaseUrl()}/verification/${appId}/confirm-website-verification`,
      undefined,
      {
        ...options,
        params: { ...params, ...options?.params },
...
export const unverifyVerificationAppIdUnverifyPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/verification/${appId}/unverify`,
    undefined,
    options,
  )
}
...
export const switchToDirectUploadVerificationAppIdSwitchToDirectUploadPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/verification/${appId}/switch_to_direct_upload`,
    undefined,
    options,
  )
}
...
export const archiveVerificationAppIdArchivePost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/verification/${appId}/archive`,
    archiveRequest,
    options,
  )
}
