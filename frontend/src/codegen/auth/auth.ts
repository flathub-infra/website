...
export const startGithubFlowAuthLoginGithubGet = (
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<StartGithubFlowAuthLoginGithubGet200>> => {
...
export const continueGithubFlowAuthLoginGithubPost = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<ContinueGithubFlowAuthLoginGithubPost200>> => {
  return axios.post(
    `/auth/login/github`,
    continueGithubFlowAuthLoginGithubPostBody,
    options,
...
export const startGitlabFlowAuthLoginGitlabGet = (
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<StartGitlabFlowAuthLoginGitlabGet200>> => {
...
export const continueGitlabFlowAuthLoginGitlabPost = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<ContinueGitlabFlowAuthLoginGitlabPost200>> => {
  return axios.post(
    `/auth/login/gitlab`,
    continueGitlabFlowAuthLoginGitlabPostBody,
    options,
...
export const startGnomeFlowAuthLoginGnomeGet = (
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<StartGnomeFlowAuthLoginGnomeGet200>> => {
...
export const continueGnomeFlowAuthLoginGnomePost = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<ContinueGnomeFlowAuthLoginGnomePost200>> => {
  return axios.post(
    `/auth/login/gnome`,
    continueGnomeFlowAuthLoginGnomePostBody,
    options,
...
export const startKdeFlowAuthLoginKdeGet = (
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<StartKdeFlowAuthLoginKdeGet200>> => {
...
export const continueKdeFlowAuthLoginKdePost = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<ContinueKdeFlowAuthLoginKdePost200>> => {
  return axios.post(
    `/auth/login/kde`,
    continueKdeFlowAuthLoginKdePostBody,
    options,
...
export const continueGoogleFlowAuthLoginGooglePost = (
  ...
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<ContinueGoogleFlowAuthLoginGooglePost200>> => {
  return axios.post(
    `/auth/login/google`,
    continueGoogleFlowAuthLoginGooglePostBody,
    options,
...
export const doLogoutAuthLogoutPost = (
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<DoLogoutAuthLogoutPost200>> => {
...
export const doAgreeToPublisherAgreementAuthAcceptPublisherAgreementPost = (
  ...
  AxiosResponse<DoAgreeToPublisherAgreementAuthAcceptPublisherAgreementPost200>
> => {
