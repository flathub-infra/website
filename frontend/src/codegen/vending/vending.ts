...
export const statusVendingStatusGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/vending/status`,
    options,
  )
}

export const getStatusVendingStatusGetQueryKey = () => {
  return [`${getApiBaseUrl()}/vending/status`] as const
}
...
export const startOnboardingVendingStatusOnboardingPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/vending/status/onboarding`,
    vendingOnboardingRequest,
    options,
  )
}
...
export const getDashboardLinkVendingStatusDashboardlinkGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/vending/status/dashboardlink`,
    options,
  )
}
...
export const getGlobalVendingConfigVendingConfigGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/vending/config`,
    options,
  )
}

export const getGetGlobalVendingConfigVendingConfigGetQueryKey = () => {
  return [`${getApiBaseUrl()}/vending/config`] as const
}
...
export const getAppVendingSetupVendingappAppIdSetupGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/vendingapp/${appId}/setup`,
    options,
  )
}
...
export const postAppVendingStatusVendingappAppIdPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/vendingapp/${appId}`,
    proposedPayment,
    options,
  )
}
...
export const getRedeemableTokensVendingappAppIdTokensGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/vendingapp/${appId}/tokens`,
    options,
  )
}
...
export const cancelTokensVendingappAppIdTokensCancelPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/vendingapp/${appId}/tokens/cancel`,
...
export const redeemTokenVendingappAppIdTokensRedeemTokenPost = (
  ...
  return axios.post(
    `${getApiBaseUrl()}/vendingapp/${appId}/tokens/redeem/${token}`,
    undefined,
    options,
  )
}
...
export const appInfoVendingappAppIdInfoGet = (
  ...
  return axios.get(
    `${getApiBaseUrl()}/vendingapp/${appId}/info`,
    options,
  )
}
