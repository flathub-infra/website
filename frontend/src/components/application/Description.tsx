        ...
        {scrollHeight > collapsedHeight && (
          <div
            ...
            className={clsx(
              ...
              !isExpanded &&
                scrollHeight > collapsedHeight &&
                "from-flathub-white before:absolute before:bottom-0 before:start-0 before:h-1/3 before:w-full before:bg-gradient-to-t before:content-[''] dark:from-flathub-dark-gunmetal",
            )}
