...
const CONTENT_SECURITY_POLICY = `
  ...
  default-src 'none';
  form-action 'none';
  script-src 'self' 'sha256-eMuh8xiwcX72rRYNAGENurQBAcH7kLlAUQcoOri3BIo=' https://webstats.gnome.org https://js.stripe.com;
  style-src 'self' 'unsafe-inline' https://dl.flathub.org;
  font-src 'self';
  connect-src 'self' https://flathub.org https://webstats.gnome.org https://api.stripe.com https://o467221.ingest.sentry.io/api/6610580/ https://github.com;
